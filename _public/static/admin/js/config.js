...
async function saveConfig() {
  ...
  try {
    ...
    if (res.ok) {
      ...
      const newAppKey = newConfig.app && newConfig.app.app_key;
      const oldAppKey = currentConfig.app && currentConfig.app.app_key;
      if (newAppKey && newAppKey !== oldAppKey) {
        await storeAppKey(newAppKey);
        apiKey = `Bearer ${newAppKey}`;
      }
